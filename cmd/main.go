...
import (
  "path"
	...
	"github.com/yefriddavid/cluster-ssh-tail/cmd/command"
	"github.com/yefriddavid/cluster-ssh-tail/cmd/console"
...
var slient = flag.String("slient", "false", "-slient=false")
...
Author: ` + Author + `
Homepage: github.com/yefriddavid/cluster-ssh-tail
